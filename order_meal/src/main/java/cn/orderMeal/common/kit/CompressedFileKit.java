 ...
 */
public class CompressedFileKit {
	/**
	 * 默认构造函数
	 */
	public CompressedFileKit() {
	...
	public static void main(String[] args) {
		CompressedFileKit compressedFileUtil = new CompressedFileKit();
		try {
			compressedFileUtil.compressedFile("/Users/xubinbin/Downloads/keys", "/Users/xubinbin/Downloads/");
